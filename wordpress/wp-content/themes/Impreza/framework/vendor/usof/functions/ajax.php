...
add_action( 'wp_ajax_usof_get_image', 'usof_ajax_get_image' );
function usof_ajax_get_image() {
	...
	if ( ! isset( $_POST['value'] ) ) {
		wp_send_json_error( array(
			'message' => __( 'Wrong request params', 'us' ),
		) );
	}

	$image = usof_get_image_src( $_POST['value'] );
