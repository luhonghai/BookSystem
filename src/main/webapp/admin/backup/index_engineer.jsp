...
<%
	...
	if(acc == null){
		...
		listQua = quaDao.getQualificationByUserId(acc.getUser_id());
		listJob = jobDao.getJobByUser(acc.getUser_id());
	}
	String accAndRole = "";
%>
<html>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index_engineer.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                    </ol>
                </section>
